...
BAD_WORDS = [
    ...
    "screwing",
    "See my story",
    "Can't send here anybodies dm me I will show you it's free",
    "Send me a message to get added now",
    "I'm a pregnancy provider dm me",
    "Skoool boy here",
    "Msg me hot skoooll boy here",
    "only for today offer",
    "sex chat",
    "incest",
    "stepmom",
    "stepsis",
